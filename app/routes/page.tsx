...
export default function () {
  ...
  return (
    <div className="w-full lg:*:w-1/2 *:w-full flex lg:flex-row flex-col">
      <main className="h-dvh flex flex-col lg:sticky lg:top-0 static justify-end gap-6 p-6">
        ...
        <div className="space-y-2 w-full">
          ...
          <span className="text-base text-muted-foreground">Компоненты, страницы, приложение и сайты</span>
        </div>
      </main>
      <div className="w-full *:p-6">
        ...
        <section className="space-y-6">
          ...
          <ul className="w-full grid grid-cols-3 gap-x-3 gap-y-6">
          ...
          <div className="w-full flex lg:flex-row flex-col gap-5 lg:*:w-1/3 *:w-full">
            ...
            <div className="w-fit space-y-1.5">
              ...
              <ul className="space-y-1.5 w-full">
                <li>
                  <Button size="lg" variant="secondary" className="xl:text-2xl text-lg font-medium py-2 h-fit">
                    <span>Созвониться</span><ArrowRightIcon className="xl:size-6 size-5" />
                  </Button>
                </li>
                <li>
                  <Button size="lg" variant="outline" className="xl:text-2xl text-lg font-medium py-2 h-fit">
